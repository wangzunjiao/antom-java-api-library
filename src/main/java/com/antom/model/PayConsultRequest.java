...
public class PayConsultRequest   extends AlipayRequest<PayConsultResponse>   {
 ...
 this.setPath("/ams/api/v1/payments");} 


   @Override 
    public Class<PayConsultResponse> getResponseClass() { 
     return PayConsultResponse.class;  
    } 

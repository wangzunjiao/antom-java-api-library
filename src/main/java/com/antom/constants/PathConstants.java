...
public class PathConstants {
  ...
  public static final String VAULTING_SESSION_PROD_PATH =
      "/ams/api/v1/vaults/createVaultingSession";
  public static final String VAULT_PAYMENTMETHOD_PROD_PATH =
      "/ams/api/v1/vaults/createVaultingSession";
  ...
  public static final String CREATE_SESSION_TEST_PATH =
      "/ams/sandbox/api/v1/payments/createPaymentSession";
  ...
  public static final String AUTH_APPLY_TOKEN_TEST_PATH =
      "/ams/sandbox/api/v1/authorizations/applyToken";
  public static final String VAULTING_SESSION_TEST_PATH =
      "/ams/sandbox/api/v1/vaults/createVaultingSession";
  public static final String VAULT_PAYMENTMETHOD_TEST_PATH =
      "/ams/api/v1/vaults/vaultPaymentMethod";
  public static final String SUBSCRIPTION_CREATE_SANDBOX_PATH =
      "/ams/sandbox/api/v1/subscriptions/create";
  public static final String SUBSCRIPTION_CANCEL_SANDBOX_PATH =
      "/ams/sandbox/api/v1/subscriptions/cancel";
  public static final String SUBSCRIPTION_CHANGE_SANDBOX_PATH =
      "/ams/sandbox/api/v1/subscriptions/change";
}
